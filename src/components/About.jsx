...
function About({ themeClass, setMenuSelected }) {
    return (
        <motion.section
            ...
            viewport={{ amount: 0.6 }}
            id="about"
            className={`transition-colors w-full h-screen flex items-center justify-center snap-start ${themeClass} px-4 pt-16 pb-4`}
        >
            <motion.div
                ...
                <div className="bg-fuchsia-950 rounded-2xl flex flex-col lg:flex-row overflow-hidden">
                    ...
                    <div className="relative lg:w-56 flex-shrink-0 flex items-center justify-center p-5 lg:p-6">
                        ...
                        <motion.img
                            ...
                            src={selfie}
                            alt="Selfie"
                            className="relative z-10 rounded-full w-24 sm:w-32 lg:w-40 shadow-2xl ring-2 ring-fuchsia-500/40"
                        />
                    </div>
                    ...
                    <div className="flex flex-col gap-3 p-5 sm:p-6 flex-1 text-white">
                        ...
                        <div>
                            <p className="text-fuchsia-400 text-xs tracking-widest uppercase font-semibold mb-0.5">who i am</p>
                            <motion.h2
                        ...
                        <p className="text-fuchsia-200/70 text-xs sm:text-sm leading-relaxed">
                            I <span className="text-white font-semibold">love</span> building web apps that feel alive. Currently focused on React and UI design, experimenting with animations, interactions, and layouts that push what the web can feel like.
                        </p>

                        <div>
                            <p className="text-fuchsia-400 text-xs tracking-widest uppercase font-semibold mb-2">interests</p>
                            <div className="flex flex-col gap-1.5">
                                {interests.map((item, i) => (
                                    <motion.div
                                        ...
                                        className="flex items-center gap-2 bg-fuchsia-900/40 border border-fuchsia-700/30 rounded-xl px-3 py-1.5 text-xs"
                                    >
                                        <Keyframe className="text-fuchsia-400 shrink-0" />
                                        <span className="text-fuchsia-100/80">{item.label}</span>
                                    </motion.div>
                                ))}
                            </div>
                        </div>
